...
class ShelfArea{
    ...
    public ShelfArea(Point p,int n,Random r){
        
    }
    public boolean hasWithin(Point p){return true;}
    public Cell getCell(Point p){return null;}
    public Point randomPoint(){return null;}
